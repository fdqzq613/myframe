...
public class MqTestController {
    ...
    public void send4(String msg) {
        ...
        //第一个参数是交换机，第二个参数是routingKey,第三个参数是要发送的消息,支持实体对象
        //ack
        amqpt.convertAndSend("some-input3", "test-routingKey", "myTestSome-routingKey:"+msg);
        amqpt.convertAndSend("some-input3", "test-routingKey2", "myTestSome-routingKey2:"+msg);
